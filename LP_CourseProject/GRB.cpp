#include "GRB.h"
#include <cstring>
#define GRB_ERROR_SERIES 110
namespace GRB
{
	/*
		S -> qlS | tfi(F){NrE;} | tfi(F){NrE;}S | tfi(){NrE;} | tfi(){NrE;}S | 
		N -> dti; | dti=E; | i=E; |  dti=E;N |  i=E;N | dti;N | oE;N |
	...
	*/
	Greibach greibach(NS('S'), TS('$'),
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 2,
			20,
				Rule::Chain(4, TS('p'), NS('E'), TS(';'), NS('N')),
				Rule::Chain(3, TS('p'), NS('E'), TS(';')),
				Rule::Chain(9, TS('I'), TS('('), NS('E'), NS('M'), TS(')'), TS('{'), NS('N'), TS('}'), NS('N')),
				Rule::Chain(8, TS('I'), TS('('), NS('E'), NS('M'), TS(')'), TS('{'), NS('N'), TS('}')),
				Rule::Chain(8, TS('I'), TS('('), NS('E'), TS(')'), TS('{'), NS('N'), TS('}'), NS('N')),
				Rule::Chain(7, TS('I'), TS('('), NS('E'), TS(')'), TS('{'), NS('N'), TS('}')),
				Rule::Chain(13, TS('I'), TS('('), NS('E'), NS('M'), TS(')'), TS('{'), NS('N'), TS('}'), TS('E'), TS('{'), NS('N'), TS('}'), NS('N')),
				Rule::Chain(12, TS('I'), TS('('), NS('E'), NS('M'), TS(')'), TS('{'), NS('N'), TS('}'), TS('E'), TS('{'), NS('N'), TS('}')),
				Rule::Chain(12, TS('I'), TS('('), NS('E'), TS(')'), TS('{'), NS('N'), TS('}'), TS('E'), TS('{'), NS('N'), TS('}'), NS('N')),
				Rule::Chain(11, TS('I'), TS('('), NS('E'), TS(')'), TS('{'), NS('N'), TS('}'), TS('E'), TS('{'), NS('N'), TS('}')),
				Rule::Chain(9, TS('w'), TS('('), NS('E'), NS('M'), TS(')'), TS('{'), NS('N'), TS('}'),NS('N')),
				Rule::Chain(8, TS('w'), TS('('), NS('E'), NS('M'), TS(')'), TS('{'), NS('N'), TS('}')),
